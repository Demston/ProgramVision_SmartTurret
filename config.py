...
SIREN_SOUND_PATH = os.path.join(script_dir, "media/audio/stop_siren.mp3")               # siren sound path
ATTACK_SOUND_PATH = os.path.join(script_dir, "media/audio/attack_sound.mp3")            # attack sound path
